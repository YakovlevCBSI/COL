...
public class timestampTest extends FormBaseTest{
	private boolean needsCleanUp=true;
	
	public timestampTest(String URL, String browser) {
		super(URL, browser);
...
//		UploadPopupPage uploadPopupPage= addCatalogPage.fillInName();
//		uploadPopupPage.selectDropBoxOption(UploadType.TXT).clickHasHeader();
//		
//		MappingPage mappingPage = (MappingPage)uploadPopupPage.clickGetFile().clickNextAfterUpload(true);
//		DetailsPage detailsPage = mappingPage.automap();
//		
...
//		UploadPopupPage uploadPopupPage= addCatalogPage.fillInName();
//		uploadPopupPage.selectDropBoxOption(UploadType.TXT).checkFullFile();
//		MappingPage mappingPage = (MappingPage)uploadPopupPage.clickGetFile().clickNextAfterUpload(true);
//		
//	}
//
...
//		
	...
	@Test
	public void updateFtpAsTest(){
		Assume.assumeTrue(getBrowser().contains("chrome"));
		updateFtpFileNames("download/fcat/qa/weekendTest");
	}
}
