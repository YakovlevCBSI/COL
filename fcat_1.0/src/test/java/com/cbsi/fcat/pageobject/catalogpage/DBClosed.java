...
//																		
//	
//	private static List<Catalog_Old> catalogsFromForm;
//	private static List<Catalog_Old> catalogsFromEmbed;
//	private static List<String> partiesLimit30;
//	private static List<Catalog_Old> activeCatalogs;
...
//		catalogsFromForm = mysql.runQuery(query_CatalogNamesForm, Catalog_Old.class, false);
//		catalogsFromEmbed = mysql.runQuery(query_CatalogNamesEmbed, Catalog_Old.class, false);
...
//		activeCatalogs = mysql.runQuery(query_searchPartyWithActiveCatalogs, Catalog_Old.class, false);
...
//		
//		
//		List<Catalog_Old> catalogsNameFromSQL = (getURL().contains(GlobalVar.embedPath) ? catalogsFromEmbed:catalogsFromForm);
//
//	
//		//CatalogsPage catalogsPage= PageFactory.initElements(driver, CatalogsPage.class);
//		List<Catalog_Old> catalogNameFromWeb = turnCatalogsTableIntoObject();
//		
//		for(Catalog_Old c: catalogsNameFromSQL){
//			System.out.println("sql: "+ c.getCatalog_name() + "/ " + c.getModifiedBy() + " / " + c.getCreated() + " / " + c.getItemCount() + " / " + c.getParty());
//		}
//		
//		for(Catalog_Old c: catalogNameFromWeb){
...
//	}
//	
//	public List<Catalog_Old> turnCatalogsTableIntoObject(){
//
//		List<WebElement> elements = driver.findElements(By.cssSelector("tbody#catalog-list-table-body tr"));
//		List<Catalog_Old> catalogsFromTable = new ArrayList<Catalog_Old>();
//		
...
//				
//				Catalog_Old catalog = new Catalog_Old();
